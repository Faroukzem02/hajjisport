...
if (isset($_POST["edit"])) {
    ...
    $update_product = $conn->prepare("UPDATE `users` SET fullname=?,tel=?,email=?,adress=?,ville=?,pays=? WHERE id='$user_id'");
    $update_product->execute([$fullname, $tel, $email, $adress, $ville, $pays]);
    ...
    <div class="manager">
        <div class="menu">
            ...
            <div class="navbar">
                ...
                <a href="edit_infos" style="color:var(--cyan)"><ion-icon name="create"></ion-icon> <span>Modifer mes infos</span> </a>
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="container_content">
                    <div class="header">
                        <p>informations personnelles > <span> modifer informations </span> > modifer mot de passe</p>
                    </div>
                    <div class="body">
                            ...
                            <form action="" method="post">
                                <div class="grids">
                                    <div class="grid">
                                        ...
                                        <input type="text" value="<?= $fetch_users["fullname"] ?>" name="fullname">
                                    </div>
                                </div>
                                ...
                                <div class="grids">
                                    <div class="grid">
                                        ...
                                        <input type="text" value="<?= $fetch_users["tel"] ?>" name="tel">
                                    </div>
                                    <div class="grid">
                                        <label for="">email</label><br>
                                        <input type="text" value="<?= $fetch_users["email"] ?>" name="email">
                                    </div>
                                </div>
                                ...
                                <div class="grids">
                                    <div class="grid">
                                        ...
                                        <input type="text" value="<?= $fetch_users["adress"] ?>" name="adress">
                                    </div>
                                    <div class="grid-flex">
                                        <div class="grid-grid">
                                            <label for="">Ville</label><br>
                                            <input type="text" value="<?= $fetch_users["ville"] ?>" name="ville">
                                        </div>
                                        <div class="grid-grid">
                                            <label for="">Pays</label><br>
                                            <input type="text" value="<?= $fetch_users["pays"] ?>" name="pays">
                                        </div>
                                    </div>
                                </div>

                                <button name="edit" type="submit">Mise a jour</button>
                            </form>
                        </div>
                    </div>
                </div>
