...
<head>
    ...
    <title>hajji sport - Napoli</title>
    <style>
        <?php
        include "style.css"
        ?>
...
<body>
    ...
    <div class="apropos">
        <?php
        $select_gallery = $conn->prepare("SELECT * FROM `napoli`");
                ...
                ?>
                    <div class="flip" id="p<?= $i ?>">
                        <div class="back">
                            ...
                            ?>
                                <img src="imgs/napoli/b-cover.png" alt="">
                                <label id="back-btn" for="c<?= $i ?>"><ion-icon name="caret-back"></ion-icon></label>
                            <?php
                            } else {
                            ?>
                                <img src="imgs/napoli/<?= $fetch_gallery[$i]["img"] ?>" alt="">
                                <label id="back-btn" for="c<?= $i ?>"><ion-icon name="caret-back"></ion-icon></label>
                            <?php
                            }
                            ?>
