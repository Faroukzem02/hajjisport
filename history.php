...
<head>
    ...
    <title>hajji sport - historique</title>
    <style>
        <?php
        include "style.css"
        ?>
    ...
    <div class="manager">
        <div class="menu">
            ...
            <div class="navbar">
                ...
                <a href="history" style="color:var(--cyan)"><ion-icon name="time"></ion-icon> <span>historique</span></a>
                ...
                <div class="container_content">
                    ...
                    <div class="table">
                        <table>
                            ...
                            <tbody>
                                <?php
                                $select_history = $conn->prepare("SELECT * from `history` ORDER BY confirm_date DESC");
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?= $fetch_history["qty"] ?></td>
                                            <td><?= $fetch_history["total_price"] ?></td>
                                            <td><?php echo date('Y-m-d', strtotime($fetch_history["command_date"])) ?></td>
                                            <td><?php echo date('Y-m-d', strtotime($fetch_history["confirm_date"])) ?></td>
                                        </tr>
                                <?php
                                    }
                                }
